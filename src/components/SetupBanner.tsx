...
export function SetupBanner() {
  ...
  // In web environment, consider Node.js setup as complete and don't show setup
  const isWebEnvironment = isWeb();
  const isNodeSetupComplete = isWebEnvironment || Boolean(nodeSystemInfo?.nodeVersion);
